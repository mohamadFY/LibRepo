...
public class BookController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Book not found",
                    content = @Content) })
    @GetMapping("/{id}")
    public ResponseEntity<Book> BookById(@PathVariable long id) throws ChangeSetPersister.NotFoundException {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Book> updateBook(@PathVariable long id , @RequestBody @Valid Book book) throws ChangeSetPersister.NotFoundException {
